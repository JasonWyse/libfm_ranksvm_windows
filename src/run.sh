JAVA_HOME/bin/javac $pro/src/ict/edu/learning/logisticRankSVM/LogisticRankSVM.java
echo 'compiling is over'
nohup $JAVA_HOME/bin/java ict/edu/learning/logisticRankSVM/LogisticRankSVM -train $pro/data/\
